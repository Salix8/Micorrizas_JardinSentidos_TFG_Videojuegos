...
\section{Planning}
To facilitate its development process, the project was divided into a set of tasks, as outlined below. Trello~\cite{trello} was used to manage the development process, organise pending tasks and track progress throughout the project.
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=\textwidth]{img/DiagramaGantt.png}
    %\framebox[\textwidth]{\rule{0pt}{5cm} \textit{Gantt chart of the project planning.}}
...
\begin{center}
\large $ \frac{18,542.34 €}{1,800} = 10.30 €/hour $
\end{center}
\end{dragonbox}
...
\begin{center}
\large $ Total labour cost = Number of hours \times 10.30 €/hour $
\end{center}

\vspace{0.2cm}
If the project required 300 hours of work: 
\begin{center}
\large $ 300 hours \times 10.30 €/hour = 3,090 € $
\end{center}
\end{dragonbox}
...
OMEN Gaming Laptop 16-ap0xxx~\cite{hp_omen}, 32GB of RAM and 954GB of hard disk, NVIDIA GeForce RTX 5070 Laptop GPU. Cost: 1,399€.
Xiaomi Redmi Note 13 Pro 5G~\cite{redmi_note}. Cost: 80€
...
\begin{itemize}
    ...
    \item \textbf{OpenAI Codex:} Used to assist in the development of certain scripts and technical problem-solving. The pricing model~\cite{codex_pricing} is based on token usage. For this project, the cost was negligible due to the small scale, but it should be considered in larger professional environments.
\end{itemize}
