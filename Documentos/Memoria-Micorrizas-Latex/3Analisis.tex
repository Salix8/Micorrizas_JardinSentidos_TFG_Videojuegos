\chapter{Analysis}
This chapter identifies the main requirements that guided the design and development of \textit{Micorrizas}. The purpose of this analysis is to establish what the system must provide in order to support the intended experience. 
...
The requirements are divided into functional (Table \ref{tab:functional_requirements}) and non-functional requirements (Table \ref{tab:non_functional_requirements}). Functional requirements describe the actions and behaviours that the system must implement. Non-functional requirements describe the quality conditions that the system must satisfy during use.

\section{Functional Requirements}

\renewcommand{\arraystretch}{1}

\definecolor{RowOdd}{HTML}{F0F5F0}
\definecolor{RowEven}{HTML}{DFE8DF}
\definecolor{HeaderDark}{HTML}{B0C9B0}

\rowcolors{1}{RowOdd}{RowEven}
...
\hline
FR04 & \textbf{Display the game map}\newline The system must show the map of the \textit{Jardín de los Sentidos} using the selected map integration. \\
\hline
